...
__all__ = [
    'DISPID_SpeechVoiceStatus', 'DISPID_SLGetWords',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTRemoveStorageFileName',
    'SAFT8kHz16BitMono', 'SPBINARYGRAMMAR', 'DISPID_SPCIdToPhone',
    'DISPID_SRCESoundEnd', 'DISPID_SPRNumberOfElements',
    'ISpeechFileStream', 'DISPID_SPEDisplayAttributes',
    'DISPID_SABIMinNotification', 'SGDSActiveWithAutoPause',
    'SPSUnknown', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRuleEngineConfidence', 'SPGRAMMARSTATE', 'SP_VISEME_16',
    'SVP_21', 'Speech_Max_Pron_Length', 'SVEPrivate',
    'ISpNotifyTranslator', 'DISPID_SLAddPronunciation', 'SPPS_Noun',
    'SPVPRI_OVER', 'SpeechRecoProfileProperties',
    'SAFT16kHz8BitStereo', 'DISPID_SGRsAdd', 'SPAS_CLOSED', 'SVP_1',
    'DISPID_SPIGetText', 'SAFT22kHz16BitMono', 'STCInprocHandler',
    'DISPID_SRCEAdaptation', 'SAFTADPCM_22kHzMono',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPIProperties', 'DISPID_SpeechMemoryStream',
    'DISPID_SDKGetStringValue', 'ISpeechObjectTokenCategory',
    'SAFT16kHz16BitStereo', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SDKEnumValues', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpNullPhoneConverter', 'SAFT24kHz16BitStereo', 'SPFM_NUM_MODES',
    'DISPID_SRAudioInputStream', 'SITooSlow', 'DISPID_SOTCategory',
    'DISPID_SGRsCommit', 'SPPS_RESERVED1', 'ISpStream',
    'SSTTTextBuffer', 'SPRST_ACTIVE', 'DISPID_SVSRunningState',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRsDynamic',
    'SECFIgnoreWidth', 'SPPHRASE', 'SAFTGSM610_44kHzMono',
    'STCInprocServer', 'SVSFParseAutodetect', 'SpPhoneConverter',
    'SRAInterpreter', 'DISPID_SOTGetDescription', 'SPEI_RESERVED3',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPPName', 'DISPID_SVEventInterests',
    'SAFTADPCM_11kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCRequestedUIType', 'SPEI_WORD_BOUNDARY',
    'SAFT8kHz8BitMono', 'SAFT48kHz16BitMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPIDSPTSI', 'SVP_14',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE11', 'SPINTERFERENCE',
    'SpeechTokenKeyFiles', 'SGRSTTRule', 'SDTPronunciation',
    'DISPID_SpeechPhraseRule', 'DISPID_SRCEFalseRecognition',
    'DISPID_SLWWord', 'DISPID_SPCPhoneToId', 'SPWORDLIST',
    'SPCS_ENABLED', 'SPLOADOPTIONS', 'SAFT32kHz16BitMono',
    'DISPID_SOTIsUISupported', 'DISPID_SLWLangId', 'SVP_7',
    'SREHypothesis', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVDisplayUI', 'SPLEXICONTYPE', 'SPEI_RECO_STATE_CHANGE',
    'SpeechAudioFormatType', 'SDA_Consume_Leading_Spaces',
    'Speech_StreamPos_RealTime', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SGRId', 'SpeechRecognizerState', 'SECFIgnoreCase',
    'DISPID_SGRSRule', 'DISPID_SpeechObjectToken',
    'SGDSActiveUserDelimited', 'DISPID_SRGDictationUnload',
    'SWTDeleted', 'DISPID_SGRAddState', 'eLEXTYPE_RESERVED4',
    'SAFT44kHz16BitMono', 'SGDisplay', 'SPEI_SENTENCE_BOUNDARY',
    'SPCONTEXTSTATE', 'SVSFIsFilename',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGId',
    ...
    'SGSEnabled', 'eLEXTYPE_PRIVATE14', 'SpSharedRecoContext',
    'SAFTADPCM_22kHzStereo', 'DISPID_SABufferNotifySize',
    'ISpeechRecognizerStatus', 'SPSNotOverriden',
    'DISPID_SpeechBaseStream', 'STSF_AppData',
    'DISPID_SGRsCommitAndSave', 'DISPID_SDKSetStringValue',
    'SDA_Two_Trailing_Spaces', 'SAFTCCITT_ALaw_44kHzMono',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SBSWrite',
    'DISPID_SRGetPropertyString', 'SPPS_NotOverriden', 'SPPS_Unknown',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPERetainedStreamOffset',
    'SPGS_EXCLUSIVE', 'DISPID_SABufferInfo', 'DISPID_SRCState',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVPause',
    'SpeechPropertyComplexResponseSpeed', 'SPBO_TIME_UNITS',
    'DISPID_SVSPhonemeId', 'ISpeechBaseStream', 'SPCT_COMMAND',
    'SGDSActive', 'SPFM_OPEN_READWRITE', 'DISPID_SOTCreateInstance',
    'SAFT11kHz8BitMono', 'SpeechCategoryAudioOut', 'SREStreamEnd',
    'ISpStreamFormat', 'SGLexical', 'ISpeechLexiconWord',
    'DISPID_SPARecoResult', 'DISPID_SBSRead',
    'SpeechWordPronounceable', 'SPEI_TTS_BOOKMARK',
    'SPEI_INTERFERENCE', 'SP_VISEME_18', 'SGSDisabled',
    'SPWAVEFORMATTYPE', 'ISpeechPhraseReplacement',
    'DISPID_SVSpeakStream', 'DISPID_SPIReplacements',
    'SPRST_ACTIVE_ALWAYS', 'SASPause', 'SGRSTTWildcard',
    'DISPID_SpeechCustomStream', 'ISpeechObjectTokens',
    'SPEI_PHRASE_START', 'SVEEndInputStream', 'SGPronounciation',
    'DISPID_SPIRule', 'SAFTDefault', 'DISPID_SRCEStartStream',
    'SREStateChange', 'ISpRecoGrammar', 'DISPID_SRCBookmark',
    'DISPID_SpeechPhraseInfo', 'SpeechAudioFormatGUIDText',
    'DISPID_SOTs_NewEnum', 'SpUnCompressedLexicon', 'SpLexicon',
    'SPSHT_Unknown', 'DISPID_SpeechPhraseElement', 'SPPS_RESERVED2',
    'ISpeechRecoGrammar', 'DISPID_SLWType',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSVisemeId',
    'ISpeechWaveFormatEx', 'SAFT16kHz8BitMono', 'SRARoot',
    'STSF_FlagCreate', 'STSF_LocalAppData', 'DISPID_SLPSymbolic',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPFM_CREATE', 'SpeechGrammarRuleStateTransitionType',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechGrammarWordType',
    'SPADAPTATIONRELEVANCE', 'ISequentialStream',
    'SPRECOGNIZERSTATUS', 'SVSFIsXML', 'DISPID_SpeechLexiconProns',
    'SpWaveFormatEx', 'SPGRAMMARWORDTYPE', 'SECNormalConfidence',
    'DISPID_SVEStreamStart', 'ISpeechObjectToken',
    'DISPID_SPIEngineId', 'eLEXTYPE_RESERVED9', 'IEnumSpObjectTokens',
    'SAFT22kHz8BitStereo', 'ISpEventSink', 'ISpResourceManager',
    '_ISpeechVoiceEvents', 'DISPID_SVGetAudioOutputs', 'SRTReSent',
    'SREFalseRecognition', 'DISPID_SRCEPhraseStart', 'SINone',
    'ISpVoice', 'SRTEmulated', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPIStartTime', 'DISPID_SMSSetData', 'ISpRecoResult',
    'SPVISEMES', 'SSFMCreateForWrite', 'SVEVoiceChange',
    'ISpNotifySink', 'SpMMAudioOut', 'DISPID_SpeechPhraseBuilder',
    'SPAR_Unknown', 'SPEI_RESERVED1', 'ISpeechAudioBufferInfo',
    'SWPKnownWordPronounceable', 'DISPID_SRProfile',
    'DISPID_SPPs_NewEnum', 'ISpGrammarBuilder', 'DISPID_SDKCreateKey',
    'SVP_17', 'DISPID_SPAs_NewEnum',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpeechPartOfSpeech',
    'SPINTERFERENCE_TOOQUIET', 'SRSEIsSpeaking',
    'ISpeechRecoResultTimes', 'DISPID_SLRemovePronunciation',
    'SREStreamStart', 'DISPID_SAVolume', 'SPFM_CREATE_ALWAYS',
    'SAFTExtendedAudioFormat', 'DISPID_SRRGetXMLErrorInfo',
    'SPPARTOFSPEECH', 'DISPID_SGRsFindRule', 'IStream',
    'DISPID_SADefaultFormat', 'DISPID_SPRuleConfidence',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPPsCount',
    'DISPID_SVEViseme', 'SSFMCreate', 'ISpeechPhraseRules', 'STCAll',
    'SpeechMicTraining', 'SP_VISEME_14',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLPPartOfSpeech',
    'SVP_2', 'SLOStatic', 'SRERequestUI',
    'SpeechPropertyResourceUsage', 'SDTLexicalForm',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRulesItem', 'SRTAutopause', 'ISpeechRecoResult',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SMSGetData', 'SPCS_DISABLED', 'SPINTERFERENCE_TOOSLOW',
    'ISpRecognizer3', 'DISPID_SOTsCount',
    'DISPID_SRCEPropertyStringChange',
    'ISpeechTextSelectionInformation', 'DISPID_SVVoice',
    'DISPID_SBSFormat', 'SpeechBookmarkOptions',
    'SpTextSelectionInformation', 'SpeechLoadOption',
    'ISpeechRecoResult2', 'SRESoundEnd',
    'ISpeechLexiconPronunciation', 'SP_VISEME_17', 'SDKLCurrentUser',
    'SpeechDiscardType', 'eLEXTYPE_PRIVATE2', 'SpeechInterference',
    'SAFT12kHz8BitStereo', 'SGDSInactive', 'SPAS_RUN',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechRecoResult2',
    'DISPID_SPEAudioSizeTime', 'SPEI_TTS_PRIVATE', 'SPVOICESTATUS',
    'SREAudioLevel', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPPFirstElement', 'DISPID_SPEActualConfidence',
    'SPRST_NUM_STATES', 'DISPID_SVSLastBookmarkId',
    'ISpStreamFormatConverter', 'ISpAudio', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRSTRule', 'DISPID_SPPParent', 'SRESoundStart',
    'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_START_INPUT_STREAM',
    'SPRULE', 'SpeechAllElements', 'ISpShortcut', 'SPPS_RESERVED3',
    'SP_VISEME_1', 'SpeechTokenKeyAttributes', 'SPEI_SR_BOOKMARK',
    'SLODynamic', 'SPINTERFERENCE_NOSIGNAL', 'SECFDefault',
    'SAFT12kHz16BitStereo', 'SPAS_STOP', 'SpeechEngineConfidence',
    'SPEI_END_INPUT_STREAM', 'SpeechUserTraining',
    'SpInProcRecoContext', 'SPSHORTCUTPAIRLIST',
    ...
    'SpSharedRecognizer', 'SAFTGSM610_22kHzMono', 'SFTInput',
    'DISPID_SPRuleId', 'SRSInactive', 'SPEI_VISEME',
    'SPINTERFERENCE_NOISE', 'SECLowConfidence',
    'DISPID_SVIsUISupported', 'SECHighConfidence',
    'DISPID_SpeechLexiconWords', 'SDKLCurrentConfig',
    'DISPID_SGRAddResource', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechCategoryAudioIn', 'SVF_None', 'SAFT48kHz8BitStereo',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechPhraseProperties',
    'DISPID_SLPLangId', 'ISpeechPhraseRule', 'DISPID_SDKDeleteKey',
    'SPEI_VOICE_CHANGE', 'SPBO_PAUSE', 'eLEXTYPE_PRIVATE18',
    'SpeechGrammarState', 'eLEXTYPE_APP', 'DISPID_SPRuleName',
    'SPEI_RECOGNITION', 'DISPID_SVStatus', 'SVEAllEvents',
    'SpeechTokenValueCLSID', 'SAFTCCITT_uLaw_44kHzMono',
    'SPSInterjection', 'SPCT_SUB_DICTATION', 'DISPID_SGRName',
    '_ISpeechRecoContextEvents', 'DISPID_SGRs_NewEnum', 'SpStream',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'SRAONone', 'DISPID_SPEPronunciation',
    'ISpeechRecoContext', 'SPPROPERTYINFO',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechGrammarRule', 'DISPID_SREmulateRecognition',
    'eLEXTYPE_PRIVATE12', 'SGRSTTTextBuffer', 'DISPID_SpeechLexicon',
    'ISpObjectWithToken', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRSTsCount', 'ISpeechPhraseReplacements',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTs_NewEnum',
    'SpMemoryStream', 'SDTDisplayText', 'SAFTCCITT_uLaw_22kHzMono',
    ...
    'DISPID_SAStatus', 'eLEXTYPE_RESERVED8', 'SSSPTRelativeToStart',
    'SPSSuppressWord', 'SpeechRegistryLocalMachineRoot',
    'SpeechRecoEvents', 'SPPS_Interjection', 'SFTSREngine',
    'SVPNormal', 'DISPID_SRSAudioStatus', 'SVSFNLPMask',
    'SPFM_OPEN_READONLY', 'SAFT24kHz8BitStereo',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCVoice', 'SP_VISEME_19',
    'SSFMOpenReadWrite', 'SAFT8kHz8BitStereo',
    'DISPID_SVAlertBoundary', 'ISpeechAudioStatus',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRCERecognition', 'SPEVENTENUM',
    'SPSEMANTICERRORINFO', 'SpStreamFormatConverter', 'SVF_Emphasis',
    'SpeechTokenKeyUI', 'SPDKL_DefaultLocation',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTsItem', 'SPSERIALIZEDPHRASE',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechGrammarRuleState',
    'SSTTWildcard', 'SAFTADPCM_44kHzMono', 'ISpEventSource',
    'DISPID_SBSSeek', 'ISpeechPhraseAlternate',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SpeechDataKey',
    'SpeechCategoryVoices', 'SAFTNonStandardFormat',
    'SAFT32kHz8BitStereo', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechRunState', 'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Noncontent',
    ...
    'ISpRecognizer2', 'DISPID_SRRAudioFormat', 'eLEXTYPE_USER',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechPhoneConverter',
    'SPXMLRESULTOPTIONS', 'DISPID_SVPriority', 'DISPID_SRRTLength',
    'SPSHT_OTHER', 'DISPID_SRGRules', 'DISPID_SPRuleChildren',
    'DISPID_SRRSaveToMemory', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_PROPERTY_STRING_CHANGE', 'SECFNoSpecialChars',
    'SpInprocRecognizer', 'SAFT44kHz8BitStereo', 'SGRSTTEpsilon',
    'SECFIgnoreKanaType', 'SPEI_MAX_SR', 'SAFTText', 'DISPID_SFSOpen',
    'DISPID_SASState', 'SWPUnknownWordPronounceable',
    'SpeechRecognitionType', 'SPDATAKEYLOCATION', 'SPEI_REQUEST_UI',
    'SpObjectTokenCategory', 'SPWT_LEXICAL', 'SRTExtendableParse',
    'DISPID_SRCRecognizer', 'DISPID_SVEBookmark', 'SPEI_RESERVED5',
    'eLEXTYPE_PRIVATE4', 'SPXRO_Alternates_SML',
    'DISPID_SpeechRecoContextEvents', 'SPAS_PAUSE',
    'DISPID_SVSInputWordLength', 'DISPID_SDKDeleteValue',
    'DISPID_SPELexicalForm', 'SDKLDefaultLocation',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPRECORESULTTIMES',
    'SPAUDIOOPTIONS', 'SSFMOpenForRead', 'SPPS_Verb',
    'SPPHRASEREPLACEMENT', 'DISPID_SRCCreateGrammar',
    'ISpeechCustomStream', 'SPLO_DYNAMIC', 'SVP_9',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRSTWeight', 'SP_VISEME_9', 'DISPID_SRCEventInterests',
    'WAVEFORMATEX', 'ISpDataKey', 'SVP_6', 'tagSTATSTG',
    'DISPID_SGRInitialState', 'DISPID_SpeechRecoResult', 'SREPrivate',
    ...
    'tagSPPROPERTYINFO', 'SGSExclusive', 'DISPID_SpeechRecognizer',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTSetId',
    'SPSHT_NotOverriden', '__MIDL_IWinTypes_0009',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPRsItem',
    'DISPID_SRCEEndStream', 'DISPID_SASetState', 'DISPID_SMSALineId',
    'DISPID_SPAStartElementInResult', 'SpeechRuleAttributes',
    'DISPID_SLGetPronunciations', 'SVP_3', 'DISPID_SRAudioInput',
    'ISpProperties', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRRRecoContext', 'SBOPause', 'SVF_Stressed',
    'ISpPhoneticAlphabetSelection', 'SRERecognition',
    'DISPID_SPRuleParent', 'DISPID_SRRTTickCount',
    'DISPID_SRCEInterference', 'SPVPRIORITY',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRDisplayUI',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SLPsCount',
    'SpNotifyTranslator', 'DISPID_SLWPronunciations',
    'SPEI_RESERVED6', 'SAFT11kHz16BitStereo', 'SPAUDIOSTATUS',
    'SPWT_DISPLAY', 'SASStop', 'SPEI_SOUND_START',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechPhraseElements', 'SDTRule', 'SPAO_NONE', 'SINoise',
    'SpCompressedLexicon', 'SPSHORTCUTPAIR', 'SPWT_PRONUNCIATION',
    'SAFT22kHz16BitStereo', 'SVPOver', 'eLEXTYPE_PRIVATE1',
    'SVSFDefault', 'SVP_13', 'SPSNoun', 'DISPID_SVEAudioLevel',
    'SVSFPurgeBeforeSpeak', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTNoAssignedFormat', 'ISpRecoContext',
    'DISPID_SVWaitUntilDone', 'SVEAudioLevel', 'DISPID_SAFType',
    'SP_VISEME_10', 'DISPID_SRRPhraseInfo', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPRs_NewEnum', 'SVSFParseMask', 'DISPID_SGRsCount',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechAudioStatus', 'SREBookmark', 'SPFILEMODE',
    'DISPID_SRStatus', 'DISPID_SpeechMMSysAudio', 'SPSFunction',
    'IInternetSecurityMgrSite',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSTNextState',
    'SVEBookmark', 'SPAO_RETAIN_AUDIO', 'DISPID_SpeechPhraseProperty',
    'SVP_4', 'SVP_18', 'DISPID_SRCESoundStart', 'SP_VISEME_7',
    'SLTApp', 'ISpeechMMSysAudio', 'SPSHT_EMAIL', 'DISPID_SRGReset',
    'DISPID_SMSAMMHandle', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPRsCount', 'SREPropertyNumChange', 'SREAdaptation',
    'DISPID_SOTId', 'ISpeechPhraseAlternates', 'eLEXTYPE_PRIVATE16',
    'SPCT_SUB_COMMAND', 'DISPID_SRGSetTextSelection', 'SRTSMLTimeout',
    'SSTTDictation', 'SpeechAudioProperties', 'SRSInactiveWithPurge',
    'eLEXTYPE_PRIVATE8', 'SPTEXTSELECTIONINFO', 'SAFT12kHz8BitMono',
    'ISpRecoCategory', 'DISPID_SpeechRecoContext', 'ISpLexicon',
    'SREAllEvents', 'SpeechCategoryRecoProfiles',
    'SpeechStreamSeekPositionType', 'SpVoice',
    'SpeechRecoContextState', 'SPEVENT', 'SAFT16kHz16BitMono',
    'DISPID_SPPsItem', 'SVP_10', 'SpeechAudioFormatGUIDWave',
    ...
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechCategoryAppLexicons',
    'SAFT44kHz8BitMono', 'DISPID_SRCERequestUI',
    'SPINTERFERENCE_NONE', 'ISpeechPhraseElements',
    'DISPID_SOTCSetId', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRIsUISupported',
    'SRATopLevel', 'ISpeechPhraseElement', 'SpeechVoicePriority',
    'SPPS_RESERVED4', 'SpCustomStream', 'SPRULESTATE', 'SPGS_ENABLED',
    'eLEXTYPE_PRIVATE9', 'SPSModifier', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEHypothesis', 'DISPID_SRSetPropertyNumber',
    'SP_VISEME_21', 'SSSPTRelativeToEnd', 'SpObjectToken',
    'SP_VISEME_4', 'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SOTCDefault',
    'SPEI_PHONEME', 'SPDKL_CurrentConfig', 'SAFTADPCM_44kHzStereo',
    'SpeechTokenShellFolder', 'DISPID_SOTCEnumerateTokens',
    'SGLexicalNoSpecialChars', 'DISPID_SMSADeviceId',
    'SPRECOCONTEXTSTATUS', 'eLEXTYPE_PRIVATE10',
    'DISPID_SGRSTPropertyId', 'SPGS_DISABLED', 'SPPS_SuppressWord',
    'SVSFParseSapi', 'ISpeechGrammarRules', 'SPCATEGORYTYPE',
    'SpeechSpecialTransitionType', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechLexiconWord', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCCreateResultFromMemory', 'SPCT_DICTATION',
    'DISPID_SRRecognizer', 'DISPID_SVSLastBookmark',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVGetVoices',
    'ISpeechLexiconWords', 'SRSActiveAlways', 'DISPID_SWFEChannels',
    'SGRSTTWord', 'SVP_5', 'DISPID_SpeechRecoResultTimes',
    'SVEStartInputStream', 'DISPID_SRGSetWordSequenceData',
    'SRSActive', 'ISpPhrase', 'DISPID_SPCLangId', 'DISPID_SVSpeak',
    'SPEI_MAX_TTS', 'DISPID_SLWsCount',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SDKOpenKey',
    'Speech_Default_Weight', 'UINT_PTR',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_PRIVATE20',
    'SWPUnknownWordUnpronounceable', 'DISPIDSPRG',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRGCommit',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVRate',
    'SPBOOKMARKOPTIONS', 'SVP_11', 'SPWORDPRONOUNCEABLE',
    'DISPID_SLWsItem', 'SpeechRegistryUserRoot',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPIDSPTSI_ActiveOffset',
    'SPSMF_UPS', 'SPPHRASERULE', 'SGRSTTDictation', 'DISPID_SPRText',
    'SDA_One_Trailing_Space', 'DISPID_SVEStreamEnd', 'SPBO_NONE',
    'DISPID_SpeechWaveFormatEx', 'SpShortcut', 'DISPID_SPEsItem',
    'SRERecoOtherContext', 'DISPID_SRGDictationSetState',
    'SVSFParseSsml', 'SVSFIsNotXML', 'IInternetSecurityManager',
    'SpeechFormatType', 'DISPID_SVSCurrentStreamNumber',
    'ISpRecoContext2', 'DISPID_SDKGetlongValue', 'DISPID_SRIsShared',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCEEnginePrivate',
    'IEnumString', 'SVEPhoneme', 'eWORDTYPE_ADDED',
    'SpeechAddRemoveWord', 'SP_VISEME_13', 'SPSLMA',
    'SAFTADPCM_8kHzMono', 'SDA_No_Trailing_Space', 'SPVPRI_NORMAL',
    'SAFT11kHz8BitStereo', 'SPCT_SLEEP', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPIGrammarId', 'DISPID_SPEAudioSizeBytes',
    'eLEXTYPE_PRIVATE17', 'ISpeechAudioFormat', 'DISPID_SVSkip',
    'SpeechVoiceSpeakFlags', 'SREPropertyStringChange',
    'SAFT48kHz8BitMono', 'SASClosed',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MIN_SR',
    'DISPID_SLPsItem', 'SDTReplacement', 'SPEI_ADAPTATION',
    'SPEI_SR_PRIVATE', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SPEDisplayText',
    'SVEWordBoundary', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechResourceLoader', 'DISPID_SABIBufferSize',
    'DISPID_SOTMatchesAttributes', 'DISPID_SASNonBlockingIO',
    'SVSFlagsAsync', 'ISpeechXMLRecoResult', 'SPVPRI_ALERT',
    'SPBO_AHEAD', 'SPDKL_CurrentUser', 'SRAORetainAudio',
    'DISPID_SpeechPhraseAlternate', 'ISpObjectToken',
    'DISPID_SRGRecoContext', 'SPRS_INACTIVE', 'ISpNotifySource',
    '_RemotableHandle', 'SpAudioFormat', 'ISpeechDataKey', 'SVP_8',
    'SpFileStream', 'SVSFPersistXML', 'SRSEDone',
    'DISPID_SVGetProfiles', 'DISPID_SRGState', 'SP_VISEME_20',
    'DISPID_SPEs_NewEnum', 'DISPID_SRRTStreamTime',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_MIN_TTS', 'SASRun',
    'SVSFVoiceMask', 'SAFTGSM610_8kHzMono', 'DISPID_SPAsItem',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPRDisplayAttributes', 'SAFT8kHz16BitStereo',
    'ISpeechAudio', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVAudioOutputStream', 'SpeechPropertyAdaptationOn',
    'ISpeechPhraseProperties', 'DISPID_SpeechPhraseRules',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPIAudioSizeBytes', 'SPRECOSTATE',
    'SpeechDataKeyLocation', 'SVPAlert', 'ISpObjectTokenCategory',
    'DISPID_SPAsCount', 'DISPID_SOTCId', 'DISPID_SRGIsPronounceable',
    'DISPID_SPISaveToMemory', 'SPWORDTYPE',
    'DISPID_SGRSTPropertyName', 'SPWORD',
    'DISPID_SVSInputWordPosition', 'DISPID_SGRSTType',
    'DISPID_SRCPause', 'DISPID_SPPId', 'SITooFast',
    ...
    'SPSTREAMFORMATTYPE', 'SVP_0', 'SPAUDIOSTATE', 'SP_VISEME_12',
    'DISPID_SAFGuid', 'SLTUser', 'SP_VISEME_8',
    'DISPID_SDKSetBinaryValue', 'tagSPTEXTSELECTIONINFO',
    'SDKLLocalMachine', 'eLEXTYPE_PRIVATE6', 'SINoSignal',
    'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechLexiconPronunciations', 'Speech_StreamPos_Asap',
    'Speech_Max_Word_Length', 'SpeechLexiconType',
    'SAFT44kHz16BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCEBookmark', 'SpeechEmulationCompareFlags', 'SRAImport',
    'SpeechCategoryPhoneConverters', 'SP_VISEME_15', 'SP_VISEME_5',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPRulesCount',
    'DISPID_SPPChildren', 'DISPID_SLGetGenerationChange',
    'DISPID_SRSetPropertyString', 'SREInterference', 'SPRST_INACTIVE',
    'SPAR_Medium', 'SPWF_SRENGINE', 'LONG_PTR', 'SPEI_UNDEFINED',
    'ISpeechPhoneConverter', 'DISPID_SAEventHandle',
    'SpeechDictationTopicSpelling', 'SAFT32kHz8BitMono',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCRetainedAudio',
    'DISPID_SVESentenceBoundary', 'SRTStandard', 'DISPID_SRState',
    'SPPS_LMA', 'SITooQuiet', 'SpeechDisplayAttributes',
    'SAFT11kHz16BitMono', 'eWORDTYPE_DELETED',
    'DISPID_SRCEAudioLevel', 'DISPID_SLPPhoneIds', 'SPPHRASEPROPERTY',
    'SpeechRetainedAudioOptions', 'SVESentenceBoundary', 'SPSVerb',
    'ISpPhoneticAlphabetConverter', 'SVP_12',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_0',
    'SITooLoud', 'SRCS_Enabled', 'DISPID_SOTDataKey', 'SWTAdded',
    'DISPID_SOTsItem', 'ISpeechPhraseInfo', 'SPSHORTCUTTYPE',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechFileStream',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE15',
    ...
    'DISPID_SGRSTransitions', 'SVP_15', 'SPDKL_LocalMachine',
    'DISPID_SRGetRecognizers', 'DISPID_SGRClear',
    'SAFT12kHz16BitMono', 'ISpeechMemoryStream', 'DISPID_SVVolume',
    'DISPID_SPACommit', 'SPWORDPRONUNCIATION', 'SRADynamic',
    'SRAExport', 'SpPhraseInfoBuilder', 'STCLocalServer',
    'DISPID_SPIElements', 'SVP_19', 'DISPID_SPIEnginePrivateData',
    'ISpRecognizer', 'SpeechAudioVolume', 'DISPID_SVEPhoneme',
    'SPEVENTSOURCEINFO', 'SPPS_Function', 'SAFT24kHz16BitMono',
    'ISpeechLexicon', 'DISPID_SRGCmdSetRuleIdState', 'SPLO_STATIC',
    'SP_VISEME_2', 'SP_VISEME_11', 'SAFT24kHz8BitMono',
    'DISPID_SVEWord', 'DISPID_SGRSTText', 'DISPID_SFSClose',
    'SP_VISEME_3', 'SPXRO_SML', 'DISPID_SPPEngineConfidence',
    'SRCS_Disabled', 'DISPID_SRGetFormat', 'ISpPhraseAlt', 'SDTAll',
    'SPEI_HYPOTHESIS', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SDKGetBinaryValue', 'eLEXTYPE_RESERVED10',
    'DISPID_SOTGetStorageFileName', 'DISPID_SAFSetWaveFormatEx',
    'eLEXTYPE_PRIVATE19', 'SPPS_Modifier', 'SBONone',
    'DISPID_SPPConfidence', 'SREPhraseStart', 'SVSFNLPSpeakPunc',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPPNumberOfElements',
    'SP_VISEME_6', 'DISPID_SRCreateRecoContext', 'SPRS_ACTIVE',
    'SVEViseme', 'ISpeechRecognizer', 'SPEI_START_SR_STREAM',
    'SpeechVisemeType', 'SDTAudio', 'ISpMMSysAudio',
    'DISPID_SRGCmdLoadFromObject', 'SPPHRASEELEMENT',
    'SpeechEngineProperties', 'DISPID_SVSLastResult',
    'SpeechGrammarTagWildcard', 'DISPID_SRRTimes',
    'eLEXTYPE_RESERVED7', 'SPEI_SR_RETAINEDAUDIO',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRRGetXMLResult',
    'SVP_16', 'DISPID_SPAPhraseInfo', 'SECFEmulateResult',
    'SPAR_High', 'SPEI_END_SR_STREAM', '_SPAUDIOSTATE',
    'DISPID_SWFESamplesPerSec', 'SPAUDIOBUFFERINFO',
    'STSF_CommonAppData', 'ISpXMLRecoResult', 'SpMMAudioIn', 'SVP_20',
    'SRADefaultToActive', 'DISPID_SPEsCount', 'DISPID_SpeechAudio',
    'SAFTCCITT_ALaw_11kHzMono', 'SDTProperty', 'DISPID_SGRsItem',
    'SpResourceManager', 'SAFTADPCM_8kHzStereo', 'DISPID_SLPType',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SWFEBitsPerSample',
    'SPSERIALIZEDRESULT', 'STCRemoteServer', 'DISPID_SLPs_NewEnum',
    'SpeechVisemeFeature', 'DISPID_SRCResume', 'SpeechAudioState',
    'ISpRecoGrammar2', 'DISPID_SVGetAudioInputs', 'SpeechRuleState',
    'SpeechTokenContext', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechObjectTokenCategory', 'SVSFUnusedFlags',
    'DISPID_SLWs_NewEnum', 'DISPID_SPEAudioStreamOffset',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechPhraseAlternates',
    'SPAR_Low', 'DISPID_SRGCmdSetRuleState', 'SpMMAudioEnum'
]
